...
<body>
  ...
  <main>
    <section class="section-video-cat" style="position: relative;">
      <h1 class="cat-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; color: white;">Categoria 1</h1>  
      <video style="width: 100%;" autoplay muted loop src="./assets/video/Lambo_gif.mp4" class="img-fluid"></video>
    </section>


    <div class="bg-video-conoce bg-custom-right mt-cat">
