...
<body>
  ...
  <main>
    ...
    <section class="py-4 fade-in container">
    ...
    <section class="section-video-cat fade-in" style="position: relative;">
      <h2 class="cat-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; color: white;">Sport</h2>  
    ...
    <section class="section-video-cat fade-in" style="position: relative;">
      <h2 class="cat-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; color: white;">Eléctrico</h2>  
    ...
    <section class="section-video-cat fade-in" style="position: relative;">
      <h2 class="cat-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; color: white;">Marítimo</h2>  
    ...
    <section class="section-video-cat fade-in" style="position: relative;">
      <h2 class="cat-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; color: white;">Motores</h2>  
    ...
    <section class="section-video-cat fade-in" style="position: relative;">
      <h2 class="cat-title" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; color: white;">4x4</h2>  
        ...
        <div class="row flex-nowrap mobile-review-container">
          ...
          <div class="col-md-4 p-3">
            <div class="client-review p-5">
              ...
              <p class="text-se-a-unido">Se unió hace 6 meses</p>
              <p>Comfy es lo mejor que me ha pasado durante estos meses que he trabajado con ellos.</p>
            </div>
          </div>
          <div class="col-md-4 p-3">
            <div class="client-review p-5">
              <h3>Juan Gutiérrez</h3>
              <div style="display:flex; margin-bottom: 10px;">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
              ...
              <p class="text-se-a-unido">Se unió hace 2 meses</p>
              <p>Comfy es lo mejor que me ha pasado durante estos meses que he trabajado con ellos.</p>
            </div>
          </div>
        </div>
