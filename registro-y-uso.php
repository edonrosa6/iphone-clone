      ...
      <section class="height-full d-flex justify-content-center align-items-center">
        <div class="container">
          <div class="row">
            <div class="col-md-6"></div>
            <div class="col-md-6">
              <p class="text-md text-white fade-in">Para acceder a los servicios de COMFY, debes registrarte y crear una cuenta. Proporcionar información precisa y actualizada durante el proceso de registro. Eres responsable de mantener la confidencialidad de tu cuenta y contraseña, y de todas las actividades que ocurran bajo tu cuenta.</p>
            </div>
          </div>
        </div>
      </section>
